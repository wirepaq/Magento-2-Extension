...
{
    const CRON_STRING_PATH = 'crontab/default/jobs/unbxd_synchronization/schedule/cron_expr';

    const CRON_MODEL_PATH = 'crontab/default/jobs/unbxd_synchronization/run/model';
