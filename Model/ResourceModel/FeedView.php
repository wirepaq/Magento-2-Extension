...
class FeedView extends AbstractDb
{
    ...
    {
        $this->_init('unbxd_productfeed_feed_view', 'feed_id');
    }
    ...
    {
        return $this->metadataPool->getMetadata(FeedViewInterface::class)->getEntityConnection();
    }
     ...
     */
    private function getFeedId(AbstractModel $object, $value, $field = null)
    {
        $entityMetadata = $this->metadataPool->getMetadata(FeedViewInterface::class);
    ...
    {
        $entityId = $this->getFeedId($object, $value, $field);
        if ($entityId) {
