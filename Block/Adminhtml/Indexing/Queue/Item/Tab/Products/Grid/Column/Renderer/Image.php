 ...
 * @team MageCloud
 */
namespace Unbxd\ProductFeed\Block\Adminhtml\Indexing\Queue\Item\Tab\Products\Grid\Column\Renderer;

use Unbxd\ProductFeed\Block\Adminhtml\Indexing\Queue\Item\Tab\Products\Grid\Column\Renderer;
...
{
    const IMAGE_ROLE = 'indexing_queue_item_product_image';
