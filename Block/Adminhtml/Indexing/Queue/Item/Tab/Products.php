 ...
 */
class Products extends GridExtended
{
    /**
    ...
    {
        parent::_construct();
        $this->setId('indexing_queue_item_products_grid');
    ...
    {
        /** @var IndexingQueue $queueItem */
        $queueItem = $this->getQueueItem();
        $actionType = $queueItem->getActionType();

        if (($actionType == IndexingQueue::TYPE_REINDEX_FULL)) {
        ...
        $entityIds = array_map(function($item) {
            return trim($item, '#');
        }, explode(', ', $queueItem->getDataForProcessing()));
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Unbxd\ProductFeed\Block\Adminhtml\Indexing\Queue\Item\Tab\Products\Grid\Column\Renderer\Image',
            ]
        );
        $this->addColumn(
            'name',
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'entity_id',
                'renderer' => 'Unbxd\ProductFeed\Block\Adminhtml\Indexing\Queue\Item\Tab\Products\Grid\Column\Renderer\Price',
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'is_salable',
                'renderer' => 'Unbxd\ProductFeed\Block\Adminhtml\Indexing\Queue\Item\Tab\Products\Grid\Column\Renderer\StockStatus'
            ]
        );
